...
import { MapaLocationInstitucion } from "./MapaInstitucion";
import { NavBarUser } from "../../Usuario/components/NavBarUser";

export const DonacionesUser = ({
  ...
  console.log("Donacion", donacionBienesProp);
            ...
            <div>
              ...
              <div>
                ...
                {donacionBienes.comunidad && (
                  <label className="text-success" id="label">{getComunidadNombre()}</label>
                )}
              </div>
