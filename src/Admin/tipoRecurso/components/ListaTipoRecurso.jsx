...
import { apiDeleteTipoRecurso, apiTipoRecursoView } from "../api/apiTipoRecurso";
import { UpdateTipoRecurso } from "./UpdateTipoRecurso";

export const ListaTipoRecurso = () => {
  ...
  const viewTipo = async () => {
    const tipoList = await apiTipoRecursoView();
  ...
  const eliminar = async (id) => {
    ...
    if (confirmacion.isConfirmed) {
      let result = await apiDeleteTipoRecurso(id);
      if (result) {
